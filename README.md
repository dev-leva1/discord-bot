...
- `/warn_add <пользователь> <причина>` - Выдать предупреждение
- `/warn_remove <пользователь> <id>` - Удалить предупреждение
- `/warn_list <пользователь>` - Список предупреждений
- `/warn_clear <пользователь>` - Очистить все предупреждения
